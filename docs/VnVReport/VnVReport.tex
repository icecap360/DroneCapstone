...
\begin{figure}[h!]
  ...
  \label{fig:segShadow}
        \includegraphics[width=1\textwidth]{VnVReport/SegmentationDarkRoad.png}
  \end{center}
\end{figure}
